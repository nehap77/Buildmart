...
public class VendorProduct_Controller {
	...
	public int updateVendorProduct(@RequestBody VendorProductPOJO v )
	{
		...
		System.out.println(v.getQuantity()+""+v.getPrice()+""+ v.getOffer_percentage()+""+v.getVpid());
		return vpservice.updateVendorProduct(v.getQuantity(), v.getPrice(), v.getOffer_percentage(),d,v.getVpid());
	}
