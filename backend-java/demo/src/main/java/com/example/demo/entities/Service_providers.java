...
public class Service_providers {
	...
	public Service_providers(int id, String first_name, String last_name, String email, String contact_number, int experience,
	...
	public Service_providers(String first_name, String last_name, String email, String contact_number, int experience, User user,
